...
open class LLImagePageControl: UIPageControl {
    ...
    open var dotInActiveImage: UIImage = UIImage(named: "LLCycleScrollView.bundle/lldotInActive.png", in: nil, compatibleWith: nil)!
    open var dotActiveImage: UIImage = UIImage(named: "LLCycleScrollView.bundle/lldotActive.png", in: nil, compatibleWith: nil)!
